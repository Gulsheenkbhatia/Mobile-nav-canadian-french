...
import WhiteEditIcon from 'toro/icons/editWhiteIcon.svg'
import PlusWhiteIcon from 'toro/icons/plusWhiteIcon.svg'
...
function ReviewList({
  ...
  const { EditIcon } = useMultiStyleConfig('Icons') as any
  ...
  const pageSize = pageSizeAllReviewsModalMobile
  ...
  return (
    ...
    >
      <Box sx={styles.reviewContentContainer}>
        <Box sx={styles.reviewTitleContainer(isModalContent)}>
          <ConditionalWrapper Wrapper={Box} condition={true} sx={styles.reviewsInfo}>
            <Box
            ...
            >
              <Experiment
                forIDs={EXPERIMENTS.PDP_V3_BELOW_THE_FOLD}
                forMobile
                data-qa="review-section"
              >
                <ReviewTitle
                  isModalContent={isModalContent}
                  title={formatMessage({
                    id: 'pdp.product.reviews',
            ...
            <Template forIDs={[TemplateName.pdpv7]} forMobile>
          ...
          {!isModalContent && ratings?.length > 0 && (
            <Template forIDs={[TemplateName.pdpv7]}>{ratingWithPercentList}</Template>
          )}

          {productId && !hideWriteReviewCta && (
            <Box
              textAlign={isReviewSectionUnderProductImage && 'center'}
              sx={
                isReviewSectionUnderProductImage
              ...
              <ReviewCTA {...writeAReviewCtaProps}>
                ...
                <Experiment forIDs={EXPERIMENTS.PDP_V3_BELOW_THE_FOLD} forMobile>
                  <Box marginLeft="var(--spacing-2)">
                    {isModalContent ? <EditIcon /> : <WhiteEditIcon />}
                  </Box>
                </Experiment>
              </ReviewCTA>
        ...
        {!isModalContent && !!reviews?.length && reviews.length > pageSizePDP && (
          <Box
            sx={styles.viewAllReviewCTAContainer(isReviewSectionUnderProductImage)}
          ...
          >
            ...
            >
              ...
              <Experiment forIDs={EXPERIMENTS.PDP_V3_BELOW_THE_FOLD} forMobile>
                <Box marginLeft="var(--spacing-2)">
                  <PlusWhiteIcon width="16px" height="16px" />
                </Box>
              </Experiment>
            </ReviewCTA>
          </Box>
