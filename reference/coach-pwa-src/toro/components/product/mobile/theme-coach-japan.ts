...
import AddToBagArea from 'toro/components/product/mobile/AddToBagArea/theme-coach-japan'
import AccessorizeIt from 'toro/components/product/mobile/AccessorizeIt/theme-coach-japan'
import RecommendationsContainer from 'toro/components/product/mobile/RecommendationsContainer/theme-coach-japan'
import RatingsAndReviews from 'toro/components/product/mobile/RatingsAndReviewsSection/themes/v6/theme-coach-japan'
