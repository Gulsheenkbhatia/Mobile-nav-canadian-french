export default {
  baseStyle: ({ theme }) => ({
    ...
    stickyContainer: (stickyAddToCartPriceEnabled, isFlyoutOpen) => ({
      ...
      right: '69px',
      p: `${theme.space.mar} ${theme.space.mar} ${theme.space.mar} 23.5px`,
      boxShadow: '0px var(--spacing-1) var(--spacing-1) 0px rgba(0, 0, 0, 0.25)',
      ...
      [`@media (max-width: ${theme.breakpoints.sm})`]: {
        ...
        p: `${theme.space.mar} ${theme.space.mar} ${theme.space.l} ${theme.space.mar}`,
